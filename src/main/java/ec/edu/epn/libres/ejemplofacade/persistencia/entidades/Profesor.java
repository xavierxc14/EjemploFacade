...
public class Profesor implements Serializable {
    ...
    public Profesor(Long id, String nombres, String apellidos, String cedula, String direccion) {
        this.id = id;
    ...
    public String toString() {
        return "ec.edu.epn.libres.conexion.persistencia.entidades.Profesor[ id=" + id + " ]";
    }
